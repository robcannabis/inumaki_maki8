...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const change = ['https://cdn.discordapp.com/attachments/1221818243904180225/1222753355395502151/v12n1as.gif?ex=6620974d&is=660e224d&hm=35ab620fa53e7358ced4577fcc114dfcc92b870296d5080885dcfbeee33c23c6&']; //รูปใหญ่
    ...
    const ddds = ['https://discord.gg/QhmzFrrDHc']; // ลิ้ง button1

   const iooi = ['Facebook']; // ชื่อ button 2
   const iiio = ['https://www.facebook.com/leebon.1928?mibextid=ZbWKwL']; // ลิ้ง button 2
